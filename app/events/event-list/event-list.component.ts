...
@Component({
    ...
    <div>
        ...
        <hr />
        <div class="row">
          <div class="col-md-5" *ngFor= "let eventListData of eventListData">
            <event-thumbnail [eventData]="eventListData"></event-thumbnail>
          </div>
        </div>
    </div>
    `,
...
export class EventListComponent {
    /* handleClick(param) {
        console.log("Recieved data: " + param.name);
    } */
    ...
    eventListData = [
      {
        ...
        onlineUrl: 'http://www.testUrl.com',
        /* location: {
          address: '1057 DT',
          city: 'London',
          country: 'England'
